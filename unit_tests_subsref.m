...
%% 
% where the first parameter defines the values of the variable a. The last 
...
% 
% The old implementation of subsref also did not respect several special 
% cases, like logical indexing or the orientation of vectors.
...
compare_ans_dbl_unc([1 5 2 4 3], 'a(logical([1 1 1 1 1 1]))');
...
compare_ans_dbl_unc(rand(2, 3, 4), 'a(2, 1.1:3.1, :)');