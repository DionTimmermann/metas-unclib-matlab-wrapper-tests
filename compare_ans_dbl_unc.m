...
%   compare_ans_dbl_unc(command)              or 
%   compare_ans_dbl_unc(a, command)           or 
%   compare_ans_dbl_unc(a, b, command)        or 
%   compare_ans_dbl_unc(a, b, c, command)     or 
%   compare_ans_dbl_unc(a, b, c, d, command)  or 
%   compare_ans_dbl_unc(a, b, c, d, e, command)
%   
%   Compares `ans` after executing `command` when using double variables
%   and unc variables from the uncLib by METAS. 
%   The first 0 to 5 arguments are values for the variables a through e,
...
%
    ...
    if nargin < 1
        error('Must pass at least a command.');
    elseif nargin > 5+1
