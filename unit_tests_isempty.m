%% Unit Tests of isempty for uncLib
% This script tests the behavior of the function isempty, which determines the 
...
%   a = unc(tmp);
%   a(:, :);
compare_ans_dbl_unc(rand(1, 3), 'isempty(a)');
compare_ans_dbl_unc([], 'isempty(a)');
compare_ans_dbl_unc(3, 'isempty(a)');
compare_ans_dbl_unc(zeros(1, 1), 'isempty(a)');
compare_ans_dbl_unc(1:3, 'isempty(a)');
compare_ans_dbl_unc([1 2 3], 'isempty(a)');
compare_ans_dbl_unc([1 2 3]', 'isempty(a)');
compare_ans_dbl_unc(rand(1, 2, 3, 4, 5), 'isempty(a)');
compare_ans_dbl_unc(rand(5, 1, 1, 1), 'isempty(a)');
compare_ans_dbl_unc(rand(5, 1, 1, 1, 5), 'isempty(a)');
